        ...
        <nav className="flex h-18 items-center justify-between">
          ...
          <div className="hidden items-center gap-6 lg:flex">
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-sm font-semibold text-navy-800 transition-colors duration-300 hover:text-bronze-600"
            >
              <svg
                aria-hidden="true"
          ...
          <div className="flex items-center gap-3 lg:hidden">
            <a
              href="tel:+14073423195"
              className="flex items-center gap-1 text-xs font-semibold text-navy-700"
              aria-label="Call (407) 342-3195"
            >
              <svg
                aria-hidden="true"
                className="h-3.5 w-3.5 text-bronze-500"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth={2}
                stroke="currentColor"
              ...
              <span className="hidden sm:inline">(407) 342-3195</span>
            </a>
            ...
            >
              <div className="flex flex-col gap-1 py-4">
                ...
                >
                  ...
                  <a
                    href="tel:+14073423195"
                    className="mt-2 flex items-center justify-center gap-2 rounded-md border border-navy-200 px-5 py-2.5 text-sm font-medium text-navy-700 transition-colors hover:bg-navy-50"
                  >
                    <svg
                      aria-hidden="true"
                      className="h-4 w-4 text-bronze-500"
