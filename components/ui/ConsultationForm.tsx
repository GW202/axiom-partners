        ...
        {status === 'success' ? (
          ...
          >
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-bronze-600">
              <svg className="h-7 w-7 text-white" aria-hidden="true" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
          ...
          >
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {serviceInterests.map((service) => {
                  ...
                  return (
                    ...
                    >
                      {isSelected && (
                        <svg className="mr-1.5 inline h-3.5 w-3.5" aria-hidden="true" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                        </svg>
                      )}
                      {service}
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              >
                {status === 'submitting' ? (
                  <>
                    <svg className="mr-2 h-4 w-4 animate-spin" aria-hidden="true" fill="none" viewBox="0 0 24 24">
